...
class SlideSection extends HTMLElement {
  ...
  initSlide() {
    ...
    this.globalSlide = new Swiper(_this, {
      ...
      grabCursor: true,
      cssMode: effect === 'slide' && !loop && !isSlideMotionHost,
      ...
      on: {
        ...
        touchMove: function (swiper, event) {
          ...
          if (!swiperMedia || event.view.innerWidth <= 767) return;
          const slidePopup = _this._slidePopupCache || (_this._slidePopupCache = document.querySelector("slide-section-popup"));
          if (slidePopup) {
        ...
        touchEnd: function (swiper, event) {
          ...
          if (event.view.innerWidth <= 767) return;
          const slidePopup = _this._slidePopupCache || (_this._slidePopupCache = document.querySelector("slide-section-popup"));
          if (slidePopup) {
...
class SlideLazyLoad {
  ...
  initSlide(el) {
    ...
    _this.globalSlide = new Swiper(el, {
      ...
      autoHeight: autoHeight,
      speed: speed,
      watchSlidesProgress: isSlideMotionHost,
      watchSlidesVisibility: isSlideMotionHost,
      cssMode: effect === 'slide' && !loop && !isSlideMotionHost,
      touchReleaseOnEdges: true,
      threshold: 2,
      longSwipesRatio: 0.3,
